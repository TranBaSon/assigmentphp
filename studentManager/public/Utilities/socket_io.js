...
/***/ (function(module, exports, __webpack_require__) {
	...
	function formatArgs(args) {
	  ...
	  args[0].replace(/%[a-zA-Z%]/g, function(match) {
	    ...
	    if ('%c' === match) {
	      ...
	      // (the users may have provided their own)
	      lastC = index;
	    }
	  });
	 ...
	 * when a users disables cookies/localstorage
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function polling (opts) {
	  ...
	  if (typeof location !== 'undefined') {
	    ...
	    // some users agents have empty `location.port`
	    if (!port) {
	      port = isSSL ? 443 : 80;
	    }
	    ...
	    if (this.hasXDR()) {
	      ...
	      xhr.onreadystatechange = function () {
	        ...
	        if (200 === xhr.status || 1223 === xhr.status) {
	          ...
	          // make sure the `error` event handler that's users-set
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * These events can't be emitted by the users.
	 *
	 * @api private
	 */
